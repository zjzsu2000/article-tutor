...
State: Weekly Stories weeks 4–5 committed and pushed (this commit) after three Codex review rounds (round 1: stories rebuilt as independent retellings; round 2: localized learner-text and doc-consistency fixes; round 3: approved with no requested changes) and owner approval covering the parent content gate (reading difficulty, week 4 dream imagery). Five round-2 minor findings remain deferred (review packages in `/tmp/weekly-4-5-review/`). Vercel auto-deploys from this push; the Cloudflare Pages mirror needs its manual redeploy (approval pending).
...
- Weekly Stories track: weeks 1–5 are integrated (4–5 pending review/commit); weeks 6–18 are "coming soon" and need original graded retellings + vocabulary + quiz before going live (see the content plan).
...
- Run the Cloudflare manual redeploy for the weeks 4–5 round once approved.
- Address the five deferred weeks 4–5 minor review findings from `/tmp/weekly-4-5-review/CODEX_REVIEW_ROUND2.md` together with the four deferred question-bank minors in one small copy-polish round.
...
git status                         # expect: weeks 4-5 round in the working tree until committed
